...
import { Beaker, Briefcase, Box, MessageSquare, FileText, CheckCircle, Factory, Truck, Layers } from 'lucide-react';
  ...
  return (
    <main className="w-full bg-white text-black pt-32 pb-24 font-sans">
      <div className="max-w-[1440px] mx-auto px-6 md:px-12">
        ...
        {/* 2. CORE SERVICES (FRAGRANCE & PRIVATE LABEL) */}
        ...
        {/* 3. PACKAGING CUSTOMIZATION (ACCENT SECTION) */}
        <section className="mb-32">
        ...
        {/* 4. THE CUSTOMIZATION PROCESS (STEPS) */}
        <section>
